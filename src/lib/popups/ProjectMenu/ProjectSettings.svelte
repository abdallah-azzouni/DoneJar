...
<ThemedDialog
	...
	h="h-[85vh]"
	mt="mt-[7.5vh]"
	cls="bg-[#FDFBF7] border-2 border-black rounded-xl shadow-[6px_6px_0px_rgba(0,0,0,0.15)] max-w-lg mx-auto overflow-hidden "
>
	<form onsubmit={handleSubmit} class="flex h-full min-h-0 flex-col">
		...
		<div class="flex-1 overflow-y-auto p-4">
			<div class="flex min-h-0 flex-1 flex-col gap-6 pr-2">
				...
				{#if newProject.id === ''}
					<div>
						<span class="mb-2 block font-patrick-hand text-xl font-bold text-gray-800">Type</span>
						<select
