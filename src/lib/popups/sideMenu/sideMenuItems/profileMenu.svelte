...
>
	<Dialog.Portal to="body">
		...
		<Dialog.Content
			class="fixed top-0 left-1/2 z-9998 mx-auto mt-10 flex h-auto max-h-[85vh] w-120 -translate-x-1/2 flex-col overflow-hidden rounded-2xl shadow-lg"
		>
			<!-- ── Header ── -->
			<div
			...
			<div class="flex-1 overflow-y-auto bg-white px-6 py-5">
				...
				{:else if activeTab === 'account'}
					<div class="space-y-3">
						...
						<div
							class="doodle-border pointer-events-none rounded-lg bg-gray-50 px-4 py-3 opacity-50"
						>
							...
							<div
								class="h-2 w-full overflow-hidden rounded-full border border-gray-400 bg-gray-200"
							>
				...
				{:else if activeTab === 'danger'}
					<div class="space-y-3">
						...
						<div
							class="doodle-border pointer-events-none rounded-lg bg-gray-50 px-4 py-4 opacity-50"
						>
